...
static const char *fonts[]          = { /*"monospace:size=18",*/
					"Symbols Nerd Font:pixelsize=28:autoint=true:autoint=true",
					"Source Code Pro:size=10" ,
					/*"Noto CJK SC:size=27:type=Regular:antialias=true:autoint=true"*/};
...
static const char col_gray3[]       = "#55494a";	/*当前非活动的title字体颜色*/
static const char col_gray4[]       = "#55494a";	/*当前活动的title字体颜色*/
static const char col_cyan[]        = "#998485";	/*title底色*/
...
//	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } },
	...
	{ MODKEY|ShiftMask,             XK_F11,      spawn,          SHCMD("light -U 10") },
	{ MODKEY|ShiftMask,             XK_F12,      spawn,          SHCMD("light -A 10") },
	{ MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("feh --recursive --randomize --bg-fill /mnt/h/图片/hacg") },
